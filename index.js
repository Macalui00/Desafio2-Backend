...
console.log(`
=======================================================================================
Desafio 2 - CODERHOUSE | BIENVENIDO AL CONTENEDOR DE PRODUCTOS.
=======================================================================================
`);
...
---------------------------------------------------------------------------------------
`);
    console.log("Guardar producto 1:");
    ...
    console.log("\n");
    console.log("Guardar producto 2:");
    ...
    console.log("\n");
    console.log("Guardar producto 3:");
